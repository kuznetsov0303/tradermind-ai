...
type GuideTopWidgetId = 'plan' | 'workflow' | 'glossary';
...
const GUIDE_UI = {
  "en": {
    ...
    "wheelTitle": "Dashboard functionality",
  ...
  "ru": {
    ...
    "wheelTitle": "Функционал личного кабинета",
  ...
  "ua": {
    ...
    "wheelTitle": "Функціонал особистого кабінету",
  ...
  "de": {
    ...
    "wheelTitle": "Dashboard-Funktionalität",
  ...
  "fr": {
    ...
    "wheelTitle": "Fonctionnalités du dashboard",
  ...
  "es": {
    ...
    "wheelTitle": "Funcionalidad del dashboard",
  ...
  "it": {
    ...
    "wheelTitle": "Funzionalità della dashboard",
  ...
  "no": {
    ...
    "wheelTitle": "Dashboard-funksjonalitet",
  ...
  "ka": {
    ...
    "wheelTitle": "პირადი კაბინეტის ფუნქციონალი",
  ...
  "pl": {
    ...
    "wheelTitle": "Funkcjonalność panelu",
  ...
  "tr": {
    ...
    "wheelTitle": "Dashboard işlevleri",
  ...
  "el": {
    ...
    "wheelTitle": "Λειτουργίες dashboard",
...
function DoubleTopPattern({
  label,
}: {
  label: string;
}) {
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-[#0F172A]">
      <svg viewBox="0 0 240 170" className="h-[92%] w-[92%] drop-shadow-[0_0_22px_rgba(0,192,118,0.22)]">
        <defs>
          <linearGradient id="doubleTopStroke" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" stopColor="#00C076" />
            <stop offset="50%" stopColor="#C8A96B" />
            <stop offset="100%" stopColor="#FF5A5F" />
          </linearGradient>
          <filter id="doubleTopGlow">
        ...
        <path
          d="M20 130 C38 98, 51 55, 76 45 C101 35, 103 82, 122 88 C143 96, 144 43, 171 45 C198 48, 199 94, 222 126"
          fill="none"
          stroke="url(#doubleTopStroke)"
          strokeWidth="7"
          strokeLinecap="round"
          strokeLinejoin="round"
          filter="url(#doubleTopGlow)"
        />
        <path d="M28 98 L212 98" stroke="#94A3B8" strokeWidth="2.4" strokeDasharray="7 7" opacity="0.78" />
        <path d="M199 112 L222 129 L201 137" fill="none" stroke="#FF5A5F" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="76" cy="45" r="6.5" fill="#C8A96B" />
        <circle cx="171" cy="45" r="6.5" fill="#C8A96B" />
        <circle cx="122" cy="88" r="5" fill="#00D084" />
        <circle cx="210" cy="123" r="5" fill="#FF5A5F" />
        <text x="120" y="23" textAnchor="middle" fill="#E6EDF7" fontSize="15" fontWeight="900">
          {label}
        </text>
      </svg>
    </div>
...
function TopGuideWidget({
  ...
  icon: ReactNode;
  isOpen: boolean;
  onToggle: (id: GuideTopWidgetId) => void;
  children: ReactNode;
}) {
  return (
    <motion.article
      layout
      className="overflow-hidden rounded-[1.6rem] border border-white/10 bg-[#0F172A]/75 shadow-xl shadow-black/20"
    >
      <button
        type="button"
        onClick={() => onToggle(id)}
        className="flex w-full items-center justify-between gap-4 p-4 text-left transition hover:bg-white/[0.035] sm:p-5"
      >
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[#00C076]/20 bg-[#00C076]/10 text-[#00D084]">
            {icon}
          </div>
          <div className="min-w-0">
            <h3 className="text-sm font-black uppercase tracking-[0.16em] text-white">{title}</h3>
            <p className="mt-1 text-xs font-bold leading-5 text-[#94A3B8]">{description}</p>
          </div>
        </div>
        <ChevronDown className={`h-5 w-5 shrink-0 text-[#94A3B8] transition ${isOpen ? "rotate-180 text-[#C8A96B]" : ""}`} />
      </button>
...
type GuideTopNavItem = {
  label: string;
  href: string;
  primary?: boolean;
};

const TOP_NAV_COPY: Record<GuideLanguage, GuideTopNavItem[]> = {
  en: [
    { label: "Home", href: "/" },
  ...
  ru: [
    ...
    { label: "Гайд по журналу", href: "/journal-guide" },
    { label: "Гайд по AI", href: "/ai-guide" },
    { label: "Личный кабинет", href: "/dashboard", primary: true },
  ],
  ua: [
    { label: "Головна", href: "/" },
    { label: "Продукт", href: "/product" },
    ...
    { label: "Гайд по журналу", href: "/journal-guide" },
    { label: "Гайд по AI", href: "/ai-guide" },
    { label: "Кабінет", href: "/dashboard", primary: true },
  ],
  zh: [
    { label: "首页", href: "/" },
    { label: "产品", href: "/product" },
    { label: "价格", href: "/pricing" },
    { label: "日志指南", href: "/journal-guide" },
    { label: "AI 指南", href: "/ai-guide" },
    { label: "仪表盘", href: "/dashboard", primary: true },
  ],
  de: [
    { label: "Start", href: "/" },
  ...
  fr: [
    ...
    { label: "Guide journal", href: "/journal-guide" },
    { label: "Guide AI", href: "/ai-guide" },
    { label: "Dashboard", href: "/dashboard", primary: true },
  ],
  es: [
    { label: "Inicio", href: "/" },
    ...
    { label: "Guía journal", href: "/journal-guide" },
    { label: "Guía AI", href: "/ai-guide" },
    { label: "Dashboard", href: "/dashboard", primary: true },
  ],
  ar: [
    { label: "الرئيسية", href: "/" },
    ...
    { label: "دليل journal", href: "/journal-guide" },
    { label: "دليل AI", href: "/ai-guide" },
    { label: "اللوحة", href: "/dashboard", primary: true },
  ],
  it: [
    { label: "Home", href: "/" },
    { label: "Prodotto", href: "/product" },
    { label: "Piani", href: "/pricing" },
    { label: "Guida journal", href: "/journal-guide" },
    { label: "Guida AI", href: "/ai-guide" },
    { label: "Dashboard", href: "/dashboard", primary: true },
  ],
  no: [
    { label: "Hjem", href: "/" },
  ...
  ka: [
    ...
    { label: "ტარიფები", href: "/pricing" },
    { label: "Journal გიდი", href: "/journal-guide" },
    { label: "AI გიდი", href: "/ai-guide" },
    { label: "კაბინეტი", href: "/dashboard", primary: true },
  ],
  pl: [
    { label: "Start", href: "/" },
    { label: "Produkt", href: "/product" },
...
function getTopNavLinks(language: GuideLanguage) {
  return TOP_NAV_COPY[language] || TOP_NAV_COPY.en;
}

const TAB_POWER_COPY: Record<DashboardGuideTabId, LocalText> = {
  overview: {
    en: "Start every session here. If Overview says risk, cut size. If it says evidence, collect screenshots. If it says review, stop adding trades and fix execution.",
    ru: "Начинай каждую сессию здесь. Если Главная показывает риск — режь размер. Если нужен evidence — собирай скрины. Если нужен review — прекращай добавлять сделки и исправляй execution.",
    ua: "Починай кожну сесію тут. Якщо Головна показує ризик — ріж розмір. Якщо потрібен evidence — збирай скрини. Якщо потрібен review — припиняй додавати угоди й виправляй execution.",
  },
  edge: {
    en: "Review this weekly. The target is not more trades; the target is a sharper personal edge and fewer repeated mistakes.",
    ru: "Разбирай это каждую неделю. Цель — не больше сделок, а острее personal edge и меньше повторяющихся ошибок.",
    ua: "Розбирай це щотижня. Ціль — не більше угод, а гостріший personal edge і менше повторюваних помилок.",
  },
  journal: {
    en: "Log the trade right after execution. Late memory is weak data; fresh data builds professional review.",
    ru: "Фиксируй сделку сразу после исполнения. Поздняя память — слабые данные; свежие факты дают профессиональный review.",
    ua: "Фіксуй угоду одразу після виконання. Пізня памʼять — слабкі дані; свіжі факти дають професійний review.",
  },
  strategy: {
    en: "Do not build five weak systems. Build one clean setup until the desk sees enough evidence to trust it.",
    ru: "Не строй пять слабых систем. Доведи один чистый setup до состояния, где desk видит достаточно evidence, чтобы ему доверять.",
    ua: "Не будуй пʼять слабких систем. Доведи один чистий setup до стану, де desk бачить достатньо evidence, щоб йому довіряти.",
  },
  charts: {
    en: "Before a trade becomes a trade, it must survive the chart. No structure, no execution.",
    ru: "До входа идея должна пройти через график. Нет структуры — нет execution.",
    ua: "До входу ідея має пройти через графік. Немає структури — немає execution.",
  },
  market: {
    en: "Use Market to choose the battlefield. Signals are for triggers; Market is for attention and context.",
    ru: "Используй Market, чтобы выбрать поле боя. Signals нужны для trigger; Market — для внимания и контекста.",
    ua: "Використовуй Market, щоб вибрати поле бою. Signals потрібні для trigger; Market — для уваги та контексту.",
  },
  alerts: {
    en: "Signals are not calls to gamble. They are trade plans. If the setup is late or invalidated, the correct move is no trade.",
    ru: "Signals — не приглашение играть. Это торговый план. Если setup поздний или invalidated — правильное действие: no trade.",
    ua: "Signals — не запрошення грати. Це торговий план. Якщо setup запізнився або invalidated — правильна дія: no trade.",
  },
  coach: {
    en: "Use Coach to clarify decisions, not to justify impulse. The desk cuts excuses.",
    ru: "Используй Coach, чтобы прояснять решения, а не оправдывать импульс. Desk режет отговорки.",
    ua: "Використовуй Coach, щоб прояснювати рішення, а не виправдовувати імпульс. Desk ріже відмовки.",
  },
  learning: {
    en: "Training is only useful when it returns to execution. Every lesson must become a rule, screenshot or better decision.",
    ru: "Обучение полезно только когда возвращается в execution. Каждый урок должен стать правилом, скрином или более чистым решением.",
    ua: "Навчання корисне тільки коли повертається в execution. Кожен урок має стати правилом, скрином або чистішим рішенням.",
  },
  reports: {
    en: "Use Reports after the session and at the end of the week. Numbers decide; mood does not.",
    ru: "Открывай Reports после сессии и в конце недели. Решают цифры, а не настроение.",
    ua: "Відкривай Reports після сесії та наприкінці тижня. Вирішують цифри, а не настрій.",
  },
  billing: {
    en: "Account is operational control. No hidden confusion: access, limits, payouts and upgrade path stay visible.",
    ru: "Account — операционный контроль. Без скрытой путаницы: доступ, лимиты, выплаты и upgrade path всегда видны.",
    ua: "Account — операційний контроль. Без прихованої плутанини: доступ, ліміти, виплати й upgrade path завжди видні.",
  },
};

function getTabPower(id: DashboardGuideTabId, language: GuideLanguage) {
  return tr(TAB_POWER_COPY[id], language);
}
...
export default function DashboardGuidePage() {
  ...
  const [openTopIds, setOpenTopIds] = useState<GuideTopWidgetId[]>([]);
  ...
  const topNavLinks = getTopNavLinks(language);
  ...
  function toggleTopWidget(id: GuideTopWidgetId) {
    setOpenTopIds((current) =>
      current.includes(id) ? current.filter((item) => item !== id) : [...current, id],
    );
  }

  function openTabFromWheel(id: DashboardGuideTabId) {
    setActiveTab(id);
  }
  ...
  return (
    ...
    >
      ...
      <section className="relative mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
        <nav className="sticky top-3 z-40 rounded-[1.35rem] border border-white/10 bg-[#07111F]/86 p-2 shadow-2xl shadow-black/30 backdrop-blur-xl">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <Link href="/" className="rounded-2xl border border-[#C8A96B]/20 bg-[#C8A96B]/10 px-4 py-3 text-xs font-black uppercase tracking-[0.18em] text-[#F5E8C9] transition hover:border-[#C8A96B]/40 hover:bg-[#C8A96B]/15">
              SkillEdge AI
            </Link>
              ...
              {topNavLinks.map((item) => (
                <Link
                  ...
                  className={`rounded-2xl px-3 py-2 text-xs font-black uppercase tracking-[0.14em] transition ${
                    item.primary
                      ? "bg-[#00C076] text-[#07111F] hover:bg-[#00D084]"
                      : "border border-white/10 bg-white/[0.035] text-[#B8C3D4] hover:border-[#00C076]/35 hover:text-white"
                  }`}
                >
                  {item.label}
                </Link>
        ...
        <header className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-7 lg:p-9">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="w-full rounded-3xl border border-white/10 bg-[#0F172A]/80 p-4 shadow-xl shadow-black/20 lg:w-[19rem]">
              <label className="block">
                <div className="mb-2 text-xs font-black uppercase tracking-[0.22em] text-[#94A3B8]">{copy.language}</div>
                <div className="relative">
                  <select
                    value={language}
                    onChange={(event) => handleLanguage(event.target.value as GuideLanguage)}
                    className="w-full appearance-none rounded-2xl border border-[#00C076]/25 bg-[#07111F] px-4 py-3 pr-11 text-sm font-black text-white outline-none transition hover:border-[#00C076]/45 focus:border-[#00D084]"
                  >
                    {LANGUAGES.map((item) => (
                  ...
                  <ChevronDown className="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#00D084]" />
                </div>
              </label>
        ...
        <section id="guide-top-widgets" className="rounded-[2rem] border border-white/10 bg-[#0F172A]/55 p-4 shadow-2xl shadow-black/25 sm:p-5">
          <div className="grid gap-3">
            <TopGuideWidget
              id="plan"
              title={copy.planTitle}
              description={copy.planIntro}
              icon={<ShieldCheck className="h-5 w-5" />}
              isOpen={openTopIds.includes("plan")}
              onToggle={toggleTopWidget}
            >
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                {planSteps.map((step, index) => (
                  <div key={step} className="rounded-2xl border border-white/10 bg-white/[0.035] p-4">
                    <div className="mb-2 flex h-8 w-8 items-center justify-center rounded-xl bg-[#C8A96B]/15 text-xs font-black text-[#C8A96B]">{index + 1}</div>
            ...
            <TopGuideWidget
              ...
              description={copy.wheelText}
              icon={<Zap className="h-5 w-5" />}
              isOpen={openTopIds.includes("workflow")}
              onToggle={toggleTopWidget}
            >
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                {DASHBOARD_TABS.map((tab) => (
                  <button
                    key={tab.id}
                    type="button"
                    onClick={() => openTabFromWheel(tab.id)}
                    className="rounded-2xl border border-white/10 bg-white/[0.035] p-4 text-left transition hover:border-[#00C076]/35 hover:bg-[#00C076]/10"
                  >
                    <div className="text-xs font-black uppercase tracking-[0.18em]" style={{ color: tab.color }}>{tab.emoji} {tr(tab.title, language)}</div>
                    <p className="mt-2 text-xs font-semibold leading-5 text-[#94A3B8]">{tr(tab.role, language)}</p>
                  </button>
                ))}
              </div>
            </TopGuideWidget>
            ...
            <TopGuideWidget
              ...
              description={copy.glossaryText}
              icon={<BookOpen className="h-5 w-5" />}
              isOpen={openTopIds.includes("glossary")}
              onToggle={toggleTopWidget}
            >
              <div className="mb-5 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <p className="max-w-2xl text-sm font-bold leading-7 text-[#94A3B8]">{copy.glossaryText}</p>
              ...
              <div className="grid max-h-[34rem] gap-3 overflow-y-auto pr-1 md:grid-cols-2 xl:grid-cols-3">
                {filteredTerms.map((item) => (
                  <motion.div key={item.term} layout className="rounded-2xl border border-white/10 bg-white/[0.035] p-4">
        ...
        <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-white/10 bg-[#0F172A]/70 p-5 shadow-2xl shadow-black/30 lg:p-7">
            ...
            <div className="relative mx-auto my-8 aspect-square w-full max-w-[34rem]">
              ...
              <div className="absolute inset-[30%] z-20 rounded-full border border-[#C8A96B]/30 bg-[#0F172A] text-center shadow-2xl">
                <DoubleTopPattern label="Double Top" />
              </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="mt-4 rounded-3xl border border-[#00C076]/20 bg-[#00C076]/10 p-5 text-sm font-bold leading-7 text-[#DDF8EE]">
                {getTabPower(active.id, language)}
              </div>
        ...
        <SiteFooter language={language} className="mt-4 rounded-[2rem] border border-white/10" />
      </section>
    </main>
  );
}
