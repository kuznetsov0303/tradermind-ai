...
const dict = {
  en: {
    ...
    heroText:
      "Quantvio AI shows why you win, why you lose, what patterns are worth trading, and when your behavior is quietly destroying your PnL.",
    ...
    problemText:
      "Screenshots, notes, watchlists and emotions are scattered everywhere. Quantvio AI connects them into one operating system for execution, review and pattern discovery.",
    problems: [
    ...
    coreText: "Quantvio AI is built for active traders, prop teams and mentors who need more than a pretty journal.",
    features: [
    ...
    agentsText:
      "Instead of one generic chatbot, Quantvio AI uses specialized agents for review, risk, market context and behavioral coaching.",
    agents: [
    ...
    ctaTitle: "Get early access to Quantvio AI",
    ...
    product: {
      ...
      aiDemoTitle: "Quantvio AI coach inside the product",
      aiDemoText: "The live app uses a secure Quantvio intelligence layer. AI depth, limits and analysis quality depend on the user's subscription plan.",
    ...
    pricing: {
      ...
      plans: [
        ["starter", "Starter", "$19", "For solo traders building consistency", ["Unlimited trade journal", "Core dashboard", "50 AI requests / month", "Quantvio Core — basic trade intelligence", "Short AI trade reviews", "Pattern tagging", "Weekly summary"]],
        ["pro", "Pro", "$49", "For active traders who want a measurable edge", ["Everything in Starter", "500 AI requests / month", "Quantvio Edge — advanced pattern intelligence", "Advanced trade and pattern review", "Discipline score", "Screenshot analysis", "Pre-trade AI coach", "Live screener matching"]],
        ["elite", "Elite", "$129", "For mentors, prop teams and serious operators", ["Everything in Pro", "2,000 AI requests / month", "Quantvio Elite — team-grade intelligence layer", "Deep reports", "Team dashboard", "Trader comparison", "Coach workspace", "White-label reports", "API access"]],
      ],
      ...
      table: [
        ...
        ["AI core", "Quantvio Core", "Quantvio Edge", "Quantvio Elite"],
    ...
    team: {
      ...
      people: [
        ["Max Volkov", "Founder & Product Lead", "Former trading desk operator turned product strategist. Built Quantvio AI around the real problem traders have: they misread their own habits."],
      ...
      origin: "Quantvio AI was born from a simple problem: traders collect endless screenshots and notes, yet still fail to see the patterns behind their real performance.",
    },
    faqTitle: "FAQ",
    faq: [
      ["Is this financial advice?", "No. Quantvio AI is a performance analytics and journaling platform, not an investment advisor."],
  ...
  ru: {
    ...
    heroText: "Quantvio AI показывает, почему ты зарабатываешь, почему теряешь, какие паттерны стоит торговать и когда твоё поведение незаметно убивает PnL.",
    ...
    problemText: "Скриншоты, заметки, вотчлисты и эмоции разбросаны по разным местам. Quantvio AI собирает всё в одну систему для исполнения, разбора и поиска закономерностей.",
    ...
    coreText: "Quantvio AI создан для активных трейдеров, проп-команд и менторов, которым нужен не просто красивый журнал.",
    ...
    agentsText: "Вместо одного обычного чат-бота Quantvio AI использует специализированных агентов для разбора, риска, рыночного контекста и поведенческого коучинга.",
    ...
    ctaTitle: "Получить ранний доступ к Quantvio AI",
    ...
    product: {
      ...
      aiDemoTitle: "Quantvio AI-коуч внутри продукта",
      aiDemoText: "Живое приложение использует защищённый интеллектуальный слой Quantvio. Глубина AI-разбора, лимиты и качество аналитики зависят от тарифа пользователя.",
    ...
    pricing: {
      ...
      table: [["Функция", "Старт", "Про", "Элит"], ["AI-ядро", "Quantvio Core", "Quantvio Edge", "Quantvio Elite"], ["AI-запросов / месяц", "50", "500", "2 000"], ["Безлимитный журнал", "Да", "Да", "Да"], ["AI-разбор сделки", "Базовый", "Продвинутый", "Глубокий"], ["Движок паттернов", "—", "Да", "Да"], ["Разбор скриншотов", "—", "Да", "Да"], ["Командный дашборд", "—", "—", "Да"]],
    },
    team: {
      eyebrow: "Команда",
      ...
      origin: "Quantvio AI родился из простой проблемы: трейдеры собирают бесконечные скриншоты и заметки, но всё равно не видят закономерности своей реальной эффективности.",
    },
    faqTitle: "FAQ",
    faq: [["Это финансовая рекомендация?", "Нет. Quantvio AI — это платформа аналитики и журналирования, а не инвестиционный советник."], ["Подойдёт ли новичкам?", "Да, но максимальная ценность появляется, когда трейдер накопит достаточно сделок для анализа паттернов."], ["Это заменяет ментора?", "Нет. Это делает менторство и самостоятельный разбор быстрее, яснее и более основанным на данных."], ["Когда запускается приложение?", "Лендинг уже запущен. Следующие этапы — private beta, аккаунты пользователей и полноценное приложение."]],
...
dict.uk = {
  ...
  heroText: "Quantvio AI показує, чому ти заробляєш, чому втрачаєш, які патерни варто торгувати і коли твоя поведінка непомітно вбиває PnL.",
  ...
  problemText: "Скріншоти, нотатки, watchlist-и та емоції розкидані по різних місцях. Quantvio AI збирає все в одну систему для виконання, аналізу та пошуку закономірностей.",
  ...
  coreText: "Quantvio AI створений для активних трейдерів, проп-команд і менторів, яким потрібен не просто красивий журнал.",
  ...
  agentsText: "Замість одного звичайного чат-бота Quantvio AI використовує спеціалізованих агентів для аналізу, ризику, ринкового контексту та поведінкового коучингу.",
  ...
  ctaTitle: "Отримати ранній доступ до Quantvio AI",
  ...
  product: {
    ...
    aiDemoTitle: "Quantvio AI-коуч усередині продукту",
    aiDemoText: "Живий продукт використовує захищений інтелектуальний шар Quantvio. Глибина AI-аналізу, ліміти та якість аналітики залежать від тарифу користувача.",
  ...
  pricing: {
    ...
    table: [["Функція", "Старт", "Про", "Еліт"], ["AI-ядро", "Quantvio Core", "Quantvio Edge", "Quantvio Elite"], ["AI-запитів / місяць", "50", "500", "2 000"], ["Безлімітний журнал", "Так", "Так", "Так"], ["AI-розбір угоди", "Базовий", "Просунутий", "Глибокий"], ["AI-рушій патернів", "—", "Так", "Так"], ["Розбір скріншотів", "—", "Так", "Так"], ["Командний дашборд", "—", "—", "Так"]]
  },
  team: {
    ...dict.ru.team,
    eyebrow: "Команда",
    ...
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative mx-auto w-full max-w-[350px]">
      <div className="rounded-[2.5rem] border border-white/15 bg-[#0d1020] p-3 shadow-[0_40px_130px_rgba(99,102,241,.25)]">
        <div className="rounded-[2rem] border border-white/10 bg-gradient-to-b from-[#141a33] to-[#080b18] p-4">
          <div className="mb-4 flex items-center justify-between text-xs text-white/50"><span>Quantvio AI</span><span>Live</span></div>
...
export default function Landing() {
  ...
  const [aiMessages, setAiMessages] = useState([{ role: "assistant", content: "Quantvio AI is ready. Ask about a setup, risk plan, mistake pattern, or screenshot review workflow." }]);
  ...
  const handleAiSubmit = async () => {
    ...
    try {
      ...
      const aiCoreMap = { starter: "Quantvio Core", pro: "Quantvio Edge", elite: "Quantvio Elite" };
      const usedPlan = d?.plan || "starter";
      setAiStatus(`${t.product.aiLive} AI core: ${aiCoreMap[usedPlan] || "Quantvio Core"}. Remaining today: ${d?.remaining ?? "—"}`);
    } catch (e) {
