...
function getPricingShowcaseCopy(lang: string) {
  if (lang === "EN") {
    return {
      ...
      paymentNotes: [
        ...
        "Crypto payment is available during launch",
      ],
      period: {
        monthly: "/ month",
        halfyear: "/ 6 months",
  ...
  if (lang === "UA") {
    return {
      ...
      paymentNotes: [
        ...
        "Crypto payment доступний на етапі запуску",
      ],
      period: {
        monthly: "/ місяць",
        halfyear: "/ 6 місяців",
  ...
  return {
    ...
    paymentNotes: [
      "Оплата картой: скоро",
      "Crypto payment доступен на этапе запуска",
    ],
    period: {
      monthly: "/ месяц",
      halfyear: "/ 6 месяцев",
...
function getSkillEdgeTeamMembers(lang: string): LandingTeamMember[] {
  ...
  return [
    {
      ...
      initials: "AS",
      photoUrl: "/team/aida-sarynova.jpg",gradient: "linear-gradient(135deg, rgba(0,192,118,0.36), rgba(15,23,42,0.92) 48%, rgba(16,185,129,0.26))",
    },
    {
      name: "Niamh O’Connor",
      ...
      initials: "NO",
      photoUrl: "/team/niamh-oconnor.jpg",gradient: "linear-gradient(135deg, rgba(16,185,129,0.34), rgba(15,23,42,0.92) 48%, rgba(59,130,246,0.28))",
    },
    {
      name: "Oliver Reed",
      ...
      initials: "OR",
      photoUrl: "/team/oliver-reed.jpg",gradient: "linear-gradient(135deg, rgba(59,130,246,0.34), rgba(15,23,42,0.92) 50%, rgba(0,192,118,0.26))",
    },
    {
      ...
      initials: "JW",
      photoUrl: "/team/james-whitfield.jpg",gradient: "linear-gradient(135deg, rgba(14,165,233,0.32), rgba(15,23,42,0.92) 50%, rgba(244,114,182,0.18))",
    },
    {
      ...
      initials: "LS",
      photoUrl: "/team/lukas-schneider.jpg",gradient: "linear-gradient(135deg, rgba(6,182,212,0.28), rgba(15,23,42,0.92) 52%, rgba(251,191,36,0.2))",
    },
    {
      name: "Marcus Hayes",
      ...
      initials: "MH",
      photoUrl: "/team/marcus-hayes.jpg",gradient: "linear-gradient(135deg, rgba(37,99,235,0.32), rgba(15,23,42,0.92) 52%, rgba(16,185,129,0.23))",
    },
    {
  name: "Michał Nowak",
  ...
  initials: "MN",
      photoUrl: "/team/michal-nowak.jpeg",gradient:
...
},
{
  ...
  initials: "JZ",
      photoUrl: "/team/jakub-zielinski.jpg",gradient:
...
},
{
  ...
  initials: "DK",
      photoUrl: "/team/dilnoza-karimova.jpg",gradient:
...
},
    {
      ...
      initials: "KW",
      photoUrl: "/team/kenji-watanabe.jpg",gradient: "linear-gradient(135deg, rgba(45,212,191,0.3), rgba(15,23,42,0.92) 52%, rgba(248,113,113,0.18))",
    },
  ];
}
    ...
    <div className="group relative min-h-[520px] overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-[0_28px_110px_rgba(0,0,0,0.26)] backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-[#C8A96B]/28 hover:bg-white/[0.065]">
      ...
      >
        ...
        <div className="absolute bottom-5 left-5 right-5">
          ...
          <div className="mt-1 text-xs font-black uppercase tracking-[0.18em] text-[#E6EDF7]/65">
            {member.country}
          </div>
        </div>
      </div>
