...
def engine_signals_client_delivery_audit(limit: int = 100, include_items: bool = True):
    ...
    return {
        ...
        "storageVersion": "s8_26b_client_delivery_audit_aliases_v1",
        "legacyVersion": "s8_22b_real_client_delivery_audit_v1",
        "evaluatedAt": datetime.now(timezone.utc).isoformat(),
        "total": len(audited),
        ...
        "reasonCounts": dict(sorted(reason_counts.items(), key=lambda kv: kv[1], reverse=True)),
